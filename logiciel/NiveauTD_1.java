...
public class NiveauTD_1 implements Niveau {
  ...
  public static final List<Generateur> GENERATEURS =
      new ArrayList<>( Arrays.asList( new Generateur(0, 25, LAPIN, 8), new Generateur(200, 0, TORTUE, 1), new Generateur(400, 25, LAPIN, 8), new Generateur(600, 0, TORTUE, 1), new Generateur(700, 0, BOSS, 1), new Generateur(800, 25, LAPIN, 8)));
