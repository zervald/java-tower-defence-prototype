...
public class Constantes {
  ...
  public static final Tuile EMPLACEMENT_TOUR =
      new Tuile(Color.gray, Color.white, BitMap.EMPLACEMENT);
  ...
  public static final PositionTuile POSITION_ARGENT =
      new PositionTuile(DIM_LARGEUR_TUILLE - 2, POSITION_ARGENT_Y);
  public static final PositionTuile POSITION_DOLLAR =
      new PositionTuile(DIM_LARGEUR_TUILLE - 1, POSITION_ARGENT_Y);
